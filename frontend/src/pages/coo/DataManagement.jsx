// frontend/src/pages/coo/DataManagement.jsx
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200/30">
      <div className="p-5 lg:p-6 max-w-[1400px] mx-auto">
        ...
        <div className={`grid gap-4 mb-6 ${
          ...
          {/* Card untuk tab mentor - Total Bimbingan */}
          {activeTab === "mentor" && (
            <div className="bg-indigo-600 rounded-xl p-4 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-2xl font-bold text-white">{stats.totalBimbingan}</p>
                  <p className="text-xs text-indigo-100 mt-0.5">Total Bimbingan</p>
                </div>
          ...
          {/* Card untuk tab divisi - Total Anggota */}
          {activeTab === "divisi" && (
            <div className="bg-indigo-600 rounded-xl p-4 shadow-sm">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-2xl font-bold text-white">{stats.totalAnggota}</p>
                  <p className="text-xs text-indigo-100 mt-0.5">Total Anggota</p>
                </div>
                <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center backdrop-blur-sm">
                  <UsersIcon className="w-5 h-5 text-white" />
                </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden mb-6">
          <div className="flex border-b border-slate-200">
            ...
            >
              <UsersIcon size={16} />
              Peserta
              <span className="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">{formattedPeserta.length}</span>
            </button>
            ...
            >
              <UserCheck size={16} />
              Mentor
              <span className="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">{formattedMentor.length}</span>
            </button>
            ...
            >
              <Building2 size={16} />
              Divisi
              <span className="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded-full">{formattedDivisi.length}</span>
            </button>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-300"
              />
            </div>
            ...
            {(activeTab === "peserta" || activeTab === "mentor") && (
              <div className="w-full md:w-48">
                <select
                  ...
                  className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-300"
                >
              ...
              <tbody>
                {paginatedData.length === 0 ? (
                  ...
                  paginatedData.map((item, idx) => (
                    <tr key={item.id || idx} className="hover:bg-slate-50/50 transition group border-b border-slate-100">
                      <td className="px-5 py-3">
                        <div className="flex items-center gap-2.5">
                          <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-sm">
                      ...
                      {(activeTab === "peserta" || activeTab === "mentor") && (
                        <td className="px-5 py-3">
                          {item.divisi && item.divisi !== "-" ? (
                            <span className="inline-flex items-center gap-1 text-xs px-2 py-1 bg-slate-100 text-slate-600 rounded-md font-medium">
                      ...
                      <td className="px-5 py-3">
                        {item.status === "aktif" ? (
                          ...
                          <span className="inline-flex items-center gap-1 text-xs px-2 py-1 bg-red-50 text-red-600 rounded-md">
            ...
            <div className="px-5 py-3 border-t border-slate-100 flex justify-between items-center bg-slate-50/30">
              ...
              <div className="flex gap-1">
                <button
                  ...
                  className="p-1.5 rounded-lg border border-slate-200 text-slate-600 disabled:opacity-50 hover:bg-slate-50"
                >
                  <ChevronLeft size={14} />
                </button>
                <div className="flex gap-1">
