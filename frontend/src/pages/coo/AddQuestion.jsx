      ...
      <div className="p-5 lg:p-6 max-w-[1400px] mx-auto">
                  ...
                  {successType === "quiz" ? (
                    <div className="flex flex-col gap-3">
                      ...
                      <button
                        ...
                        className="w-full py-3 border border-slate-200 rounded-xl text-slate-600 text-sm font-medium hover:bg-slate-50 transition-all"
                      >
        ...
        <div className="mb-6">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="flex">
              <div className={`flex-1 flex items-center gap-3 px-5 py-4 transition-all ${
                currentStep === 1 
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                      ...
                      <button
                        ...
                        className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs font-medium rounded-lg transition-all duration-200 shadow-sm"
                      >
                        {downloadingTemplate ? (
                          <>
